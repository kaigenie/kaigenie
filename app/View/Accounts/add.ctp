<div class="setup-box account-new">
  <div class="hd">
    <?php echo __('Add Account') ?>
  </div>
  ...
  <div class="con span8">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <?php
        // now we only need New Zealand
        echo $this->Form->hidden('country', array("value"=>"New Zealand"));
        echo $this->Form->hidden('state', array("value"=>""));
        ?>
